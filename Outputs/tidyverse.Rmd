...
```{r loading_packages, eval=FALSE, message=FALSE, warning=FALSE, include=TRUE}
...
```{r load_package2, echo = TRUE, warning=FALSE, message=FALSE}

#install.packages("pacman",repos="https://cran.stat.auckland.ac.nz/" )
#(remove # and run if needed)
